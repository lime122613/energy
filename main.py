...
# --------------------------
st.title("2024 전국 전력 사용량 시각화 · 탐색 플랫폼")
st.header("🌍 1. 전체 전력 사용량 기준 시도별 순위")
...
# --------------------------
st.header("📈 4. 시군구별 계약종 월별 사용량 비교")
